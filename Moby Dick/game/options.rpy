...
define gui.about = _p("""{b}Other than some component pieces of software available under their own licenses, {i}"""+config.name+"""{/i} is released into the public domain.{/b}

{i}Moby-Dick{/i} was written by Herman Melville, and published in 1851.
